...
class ShowAppPage extends StatefulWidget {
  @override
  ShowAppPageState createState() => new ShowAppPageState();
}

class ShowAppPageState extends State<ShowAppPage> {
  ...
  @override
  void didUpdateWidget(ShowAppPage oldWidget) {
